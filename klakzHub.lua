-- klakz Hub - Genişletilmiş Ultimate Script Arşivi
...
TitleBar.Text = "  ⚡ klakz Hub - Genişletilmiş Arşiv"
...
TabList.CanvasSize = UDim2.new(0, 0, 2.5, 0)
...
ContentFrame.CanvasSize = UDim2.new(0, 0, 3.5, 0)
...
-- ==================== SEKME 7: YENİ EKLENEN OYUNLAR (Vanguard & Gym & Type Soul vb.) ====================
local Tab7 = CreateTab("Yeni Popüler Oyunlar")

AddButton(Tab7, "Anime Vanguards (Auto Farm/Summon)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptpastebin/raw/main/AnimeVanguards"))()
end)

AddButton(Tab7, "Gym League (Auto Train/Muscle)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/GymLeague"))()
end)

AddButton(Tab7, "Type Soul (Auto Farm/Boss)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/xu-dev/typesoul/main/loader.lua"))()
end)

AddButton(Tab7, "Arm Wrestle Simulator (Auto Click/Win)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/ArmWrestle"))()
end)

AddButton(Tab7, "Anime Defenders", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PlatClient/AnimeDefenders/main/Main"))()
end)

AddButton(Tab7, "Doors (ESP & Entity Notifier)", function()
